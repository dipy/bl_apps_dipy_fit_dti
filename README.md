...
### Citations
We kindly ask that you cite the articles in the following [link](https://dipy.org/documentation/1.1.1./reference_cmd/dipy_fit_dti/) when publishing papers and code using this code.
